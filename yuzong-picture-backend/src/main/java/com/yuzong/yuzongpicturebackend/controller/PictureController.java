...
import com.yuzong.yuzongpicturebackend.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.yuzong.yuzongpicturebackend.api.imagesearch.ImageSearchApiFacade;
...
import com.yuzong.yuzongpicturebackend.manager.auth.model.SpaceUserPermission;
...
import com.yuzong.yuzongpicturebackend.model.vo.PictureTagCategory;
...
//        判断参数
        ...
        // 注意将 list 转为 string，因为前端传递的是 list，实体类中是 string
