package com.yuzong.yuzongpicture.domain.picture.service.impl;
...
import com.yuzong.yuzongpicture.infrastructure.manager.upload.PictureUploadTemplate;
...
//        checkPictureAuth(loginUser, oldPicture);
    ...
    public void checkPictureAuth(User loginUser, Picture picture) {
        ...
        if (spaceId == null) {
            // 公共图库，本人或管理员可操作
            if (!loginUserId.equals(picture.getUserId()) && !loginUser.isAdmin()) {
