package com.yuzong.yuzongpicture.shared.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // 最后得到：yuzong_picture.picture_1xxxx, yuzong_picture.picture_2xxxx,
        //         yuzong_picture要改为自己的数据库。
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "yuzong_picture." + tableName) // 确保前缀合法
